...
<div class="card">
    <div class="card-header">
        <h3 class="card-title" style="font-size: 1.5em;font-weight:bold">Create New Supplier</h3>
...
<div class="card-body">
    ...
    <input type="submit"  class="btn btn-primary" value="Create New Supplier">
</form>
</div>
@stop 