...
<div class="card">
    <div class="card-header">
        <h3 class="card-title" style="font-size: 1.5em;font-weight:bold">Edit product : {{ $product->product_name }}</h3>
...
<div class="card-body">
    ...
    <div class="form-group">
        ...
        @endif" value="{{ old('product_name')??$product->product_name }}">
        @error('product_name')
    ...
    <div class="form-group">
        ...
        @endif" value="{{ old('product_code')??$product->product_code}}">
        @error('product_code')
        <small class="form-text text-danger">{{ $message }}</small>       
        @enderror
    </div>
    <div class="form-group">
        ...
        <select name="category_id" class="form-control">
            <option disabled="" selected=""></option>
                @foreach ($cat as $row)
                    <option value="{{ $row->id }}"<?php if($product->category_id==$row->id){echo "selected";}?>>{{ $row->cat_name }}</option>
                @endforeach
        </select>
    </div>
    <div class="form-group">
        ...
        <select name="supplier_id" class="form-control">
            <option disabled="" selected=""></option>
                @foreach ($sup as $row)
                    <option value="{{ $row->id }}"<?php if($product->supplier_id==$row->id){echo "selected";}?>>{{ $row->name }}</option>
                @endforeach
        </select>
    </div>
    <div class="form-group">
        ...
        @endif" value="{{ old('product_place')??$product->product_place }}">
        @error('product_place')
        <small class="form-text text-danger">{{ $message }}</small>       
        @enderror
    </div>
    <div class="form-group">
        ...
        @endif" value="{{ old('buy_date')??$product->buy_date}}">
        @error('buy_date')
        <small class="form-text text-danger">{{ $message }}</small>       
        @enderror
    </div>
    <div class="form-group">
        ...
        @endif" value="{{ old('expire_date')??$product->expire_date }}">
        @error('expire_date')
        <small class="form-text text-danger">{{ $message }}</small>       
        @enderror
    </div>
    <div class="form-group">
        ...
        @endif" value="{{ old('buying_price')??$product->buying_price}}">
        @error('buying_price')
        <small class="form-text text-danger">{{ $message }}</small>       
        @enderror
        ...
        @endif" value="{{ old('selling_price')??$product->selling_price}}">
        @error('selling_price')
        <small class="form-text text-danger">{{ $message }}</small>       
        @enderror
    </div>
