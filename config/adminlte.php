    ...
    */
    ...
    'menu' => [
        ...
        [
            'text' => 'Employees',
            'url'  => '/admin/empolyees',
            'icon' => 'nav-icon fas fa-fw fa-house-user',
            'submenu' => [
                [
        ...
        [
            ...
            'submenu' => [
                [
                    'text' => " Add Advanced Salary",
                    'url' => '/admin/salaries/create',
                    'icon' => 'nav-icon fas fa-fw fa-plus',
                ],
                [
                    'text' => 'View All Advanced Salary',
                    'url' => '/admin/salaries',
                    'icon' => 'nav-icon fas fa-fw fa-eye',
                ],
                [
                ...
                [
                    ...
                    'url' => '/admin/salaries',
                    'icon' => 'nav-icon fas fa-fw fa-search-dollar',
                ],
            ]
        ],
        [
        ...
        [
            'text' => 'Product',
            'url'  => '/admin/products',
            'icon' => 'nav-icon fas fa-fw fa-boxes',
            'submenu' => [
                [
                    'text' => "Add Products",
        ...
        [
            'text' => 'Expenses',
            'url'  => '/admin/expenses',
            'icon' => 'nav-icon fas fa-fw fa-money-bill',
            'submenu' => [
                [
                    'text' => "Add Expenses",
